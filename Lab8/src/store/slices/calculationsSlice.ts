...
export const acceptCalculation = createAsyncThunk<void, string, AsyncThunkConfig>(
    ...
    async function(calculation_id) {
        return await api.calculations.calculationsUpdateStatusAdminUpdate(calculation_id, { status: 3 }) as AxiosResponse<T_Calculation>
    }
)

export const declineCalculation = createAsyncThunk<void, string, AsyncThunkConfig>(
    "calculations/decline_calculation",
    async function(calculation_id) {
        return await api.calculations.calculationsUpdateStatusAdminUpdate(calculation_id, { status: 4 }) as AxiosResponse<T_Calculation>
    }
)
