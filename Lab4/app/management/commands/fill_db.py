...
def add_users():
    ...
    def create_user_if_not_exists(username, email, password, first_name, last_name, is_superuser=False):
        try:
            if is_superuser:
    ...
    create_user_if_not_exists("user", "user@user.com", "1234", first_name="user", last_name="user")
    create_user_if_not_exists("root", "root@root.com", "1234", first_name="root", last_name="root", is_superuser=True)

    for i in range(1, 10):
        create_user_if_not_exists(f"user{i}", f"user{i}@user.com", "1234", first_name=f"user{i}", last_name=f"user{i}")
        create_user_if_not_exists(f"root{i}", f"root{i}@root.com", "1234", first_name=f"user{i}", last_name=f"user{i}", is_superuser=True)
...
def add_codes():
    ...
    Code.objects.create(
        name="0101011110101010",
        description="0101011110101010010101111010101001010111101010100101011110101010010101111010101001010111101010100101011110101010010101111010101001010111101010100101011110101010",
        weight=32,
        image="3.png"
    )
    ...
    Code.objects.create(
        name="10110111101101001",
        description="101101111011010011011011110110100110110111101101001101101111011010011011011110110100110110111101101001101101111011010011011011110110100110110111101101001",
        weight=256,
        image="4.png"
    )
    ...
    Code.objects.create(
        name="10101101011001010",
        description="1010110101100101010101101011001010101011010110010101010110101100101010101101011001010101011010110010101010110101100101010101101011001010101011010110010101010110101100",
        weight=128,
        image="5.png"
    )
